export const Card = ({timeA, timeB, match}) => (
    ...
    <div className="flex flex-col justify-center space-y-6 border border-grey-300 sm:px-20 md:px-40 lg:px-80 px-4 py-5 rounded-xl">
                        ...
                        <div className="flex space-x-6 justify-center items-center">
                            ...
                            <input className="text-red-500 font-bold text-center bg-red-500/[0.3] w-[45px] h-[35px]" type="number"></input>
